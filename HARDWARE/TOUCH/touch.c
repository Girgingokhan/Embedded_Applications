...
///////////////////////////////////////////////// ////////////////////////////////
//Touch button scan
//tp:0, screen coordinates; 1, physical coordinates (used in special occasions such as calibration)
...
u8 TP_Scan(u8 tp)
{
	if(PEN==0)//A button is pressed
	{
		...
		if((tp_dev.sta&TP_PRES_DOWN)==0)//It has not been pressed before
		{
		tp_dev.sta=TP_PRES_DOWN|TP_CATH_PRES;//Press the button
